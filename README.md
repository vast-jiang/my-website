...
![alt text](https://img.shields.io/badge/Astro_v5-2C2052?style=for-the-badge&logo=astro&logoColor=white)

![alt text](https://img.shields.io/badge/Tailwind_v4-38B2AC?style=for-the-badge&logo=tailwind-css&logoColor=white)

![alt text](https://img.shields.io/badge/TypeScript-5.0-007ACC?style=for-the-badge&logo=typescript&logoColor=white)
...
这不仅仅是一个静态博客，它包含了一个虚拟文件系统 (VFS)、全局命令行终端以及沉浸式媒体体验。
✨ 核心特性
模块	功能描述
...
🎵 媒体中心	全局持久化音乐播放器，支持切歌、暂停与实时频谱可视化。
🏷️ 索引系统	数据库风格的标签云 (Tag Cloud)，支持多维度筛选文章。
💬 通讯模块	集成 Giscus 评论系统，定制化透明暗色主题，完美融入玻璃面板。
...
🎮 Terminal Commands
Press Ctrl + K to toggle the global terminal:
